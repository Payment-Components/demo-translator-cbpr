...
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-cbpr/3.34.1/translator-cbpr-3.34.1-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-cbpr:3.34.1:demo@jar'
```
Import additional dependencies if not included in your project
```groovy
