...
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-cbpr/2.1.0/translator-cbpr-2.1.0-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-cbpr:2.1.0:demo@jar'
```
