...
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-cbpr/3.0.0/translator-cbpr-3.0.0-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-cbpr:3.0.0:demo@jar'
```
