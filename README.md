...
Incorporate the SDK [jar](https://nexus.paymentcomponents.com/repository/public/gr/datamation/translator-cbpr/4.2.2/translator-cbpr-4.2.2-demo.jar)
...
Import the SDK
```groovy
implementation 'gr.datamation:translator-cbpr:4.2.2:demo@jar'
```
Import additional dependencies if not included in your project
```groovy
